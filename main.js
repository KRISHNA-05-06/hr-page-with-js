...
function addInterview() {
  var interviewDepartment = document.querySelector("#int-department").value;
  var interviewPosition = document.querySelector("#int-position").value;
  ...
  <li>
    ...
    <div class="list-item">
      ...
      <h3>` + interviewDepartment + `</h3>
      <p>` + interviewPosition + `</p>
